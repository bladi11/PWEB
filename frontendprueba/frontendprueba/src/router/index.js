...
// Juego
import Juego from '../views/App/Juego/Juego'
// vehiculo
import Vehiculo from '../views/App/Vehiculo/Vehiculo'
// motos
import Moto from '../views/App/Moto/Moto'
// encriptacion
import Encriptacion from '../views/App/Encriptacion/Encriptacion.vue'
...
const JuegoRoutes = (prop, mode) => [
  {
    path: 'juego',
    name: prop + '.juego',
    meta: { dark: mode, auth: true, name: 'juego' },
    component: Juego
  }
]
...
const MotoRoutes = (prop, mode) => [
  {
    path: 'moto',
    name: prop + '.moto',
    meta: { dark: mode, auth: true, name: 'moto' },
    component: Moto
  }
]
const EncriptacionRoutes = (prop, mode) => [
  {
    path: 'encri',
    name: prop + '.encri',
    meta: { dark: mode, auth: true, name: 'encri' },
...
const routes = [
  ...
  },
  {
    ...
    component: Layout1,
    meta: { auth: true },
    children: EncriptacionRoutes('encri')
  },
  {
    path: '/',
    name: 'login',
